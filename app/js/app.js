...
class App extends React.Component {
    ...
    componentDidUpdate(props,states) {
        console.log("componentDidUpdate:",props,states);
    }
        ...
        return (
            <form name="form" noValidate>
                <div className="form-group">
                    <label className="control-label">operate virtualDom</label>
...
class ParentNode extends React.Component {
    ...
    handleClick() {
        console.log(this.refs.childNodeRef,111);
    ...
    render() {
        ...
        return (
            ...
            <App from="input" ref="childNodeRef"></App>
